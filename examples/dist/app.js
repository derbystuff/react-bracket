...
var getParticipant = function getParticipant(options) {
		var index = options.data[options.info][options.placement];
		var participant = participants[index];
		return participant ? React.createElement(
				'span',
				null,
				participant
		) : React.createElement(
...
module.exports = React.createClass({
		...
		render: function render() {
				return React.createElement(Bracket, { layout: layout, data: data, participants: participants, getParticipant: getParticipant });
		}
});
...
module.exports = React.createClass({
  ...
  getRacerInfo: function getRacerInfo(options) {
    ...
    return React.createElement(Participant, { info: details });
  },
  render: function render() {
    return React.createElement(Bracket, { className: 'bigger', layout: layout, data: data, participants: racers, getParticipant: this.getRacerInfo });
  }
});
...
var layout = [[[0, 1], null, [2, 3], null, null, null, null, null], [[null, 4], [3, 5], null, null], [[null, 5], null], [[]], []];
...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(Bracket, { layout: layout, participants: participants, getParticipant: getParticipant })
    );
  }
});
