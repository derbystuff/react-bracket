...
React.render(React.createElement(
	...
	React.createElement(LateEntry, null),
	React.createElement(
		'h2',
		null,
		'Custom Data'
	),
	React.createElement(CustomData, null)
), document.getElementById('example'));

},{"./samples/basic.jsx":2,"./samples/customdata.jsx":3,"./samples/lateentry.jsx":4,"react":160,"react-bracket":undefined}],2:[function(require,module,exports){
'use strict';

var React = require('react'),
    Bracket = require('react-bracket');

var data = [[[0, 1], [2, 3]], [[0, 3]], [[3]]];
...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(Bracket, { data: data, participants: participants });
  }
});

},{"react":160,"react-bracket":undefined}],3:[function(require,module,exports){
'use strict';

var React = require('react'),
    Bracket = require('react-bracket');

var data = [[[{ car: 101, phase1: 0.25 }, { car: 102, phase2: 0.25 }], [{ car: 103 }, { car: 104, phase1: 0.002, phase2: 0.12 }]], [[{ car: 102, phase1: 0.25 }, { car: 104, phase2: 0.35 }]], [[{ car: 104 }]]];
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        'span',
        { className: 'right' },
        React.createElement('input', { type: 'text', className: 'phase-time', defaultValue: info.phase1 || '' }),
        React.createElement('input', { type: 'text', className: 'phase-time', defaultValue: info.phase2 || '' })
      )
    );
  }
});
...
module.exports = React.createClass({
  ...
  getRacerInfo: function getRacerInfo(options) {
    var carNumber = (options.id || {}).car,
    ...
    if (!car) {
      return {
        display: React.createElement(ParticipantPicker, { participants: participants })
      };
    }
    ...
    return {
      display: React.createElement(Participant, { info: car })
    };
  },
  render: function render() {
    return React.createElement(Bracket, { data: data, participants: racers, competitorInfo: this.getRacerInfo });
  }
});

},{"react":160,"react-bracket":undefined}],4:[function(require,module,exports){
'use strict';

var React = require('react'),
    Bracket = require('react-bracket');

var data = [[[0, 1], null, [2, 3], null, null, null, null, null], [[null, 4], [3, 5], null, null], [[null, 5], null], [[]], []];
...
module.exports = React.createClass({
  ...
  render: function render() {
    return React.createElement(
      'div',
      null,
      React.createElement(Bracket, { data: data, participants: participants })
    );
  }
});

},{"react":160,"react-bracket":undefined}],5:[function(require,module,exports){
